...
pg_crud_assignment/
│
├── app.py                 # Main Python application (CRUD menu + logic)
...
├── README.md              # Project instructions, setup, and video link
│
└── db/                    # Folder for database scripts
    ├── schema.sql         # Creates the 'students' table with all fields
    └── seed.sql           # Inserts the initial 3 student records
